...
module.exports = /*#__PURE__*/ _asyncToGenerator(function*() {
  const defaultConfig = yield require("./index")("/path/to/project");

  const validConfig = _objectSpread(
    _objectSpread({}, defaultConfig),
    {},
    {
      resolver: _objectSpread(
        _objectSpread({}, defaultConfig.resolver),
        {},
        {
      ...
      transformer: _objectSpread(
        _objectSpread({}, defaultConfig.transformer),
        {},
        {
      ...
      serializer: _objectSpread(
        _objectSpread({}, defaultConfig.serializer),
        {},
        {
